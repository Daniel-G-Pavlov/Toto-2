...
public class TotoSix {

    private JLabel TotoPanel;
    ...
    private JTextArea ващитеЧислаСаTextArea;
    private JButton choisNumbarButton;
    private JButton pullingNumbersButton;
    private JButton resulButton;
    private JTextPane ПЕЧАЛБИTextPane;
    private JTextArea първоТегленеTextArea;
    private JTextArea второТегленеTextArea;
    private JTextArea третоТегленеTextArea;
    private JTextArea виеУлучихтеTextArea;
    private JTextArea виеУлучихтеTextArea2;
    private JTextArea виеУлучихтеTextArea1;
